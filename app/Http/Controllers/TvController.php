...
class TvController extends Controller
{
    ...
    public function getTvDiscover(Request $request)
    {
        ...
        $url = "https://api.themoviedb.org/3/discover/tv?" . "api_key=" . env('MOVIE_DATABASE_API_KEY') . "&language=en-US" . "&sort_by=" . $sort . "&with_genres=" . $genres . "&first_air_date_year=" . $year . "&vote_count.gte=50" . "&page=" . $page;
